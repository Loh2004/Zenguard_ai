...
# ---------------------------------------------------------
DEFAULT_BACKUP_KEY = "AQ.Ab8RN6K9CG6nngMTXfiWiGGYUwq-lCMi2pH7j1JU36z-gQLa_Q"
...
with st.sidebar:
    ...
    with st.expander("⚙️ Advanced Settings", expanded=False):
        api_key_input = st.text_input(
            ...
            type="password",
            help="Configured automatically. You can also paste your own custom Gemini key.",
        )
...
def get_gemini_client():
    key = api_key_input.strip() if ("api_key_input" in locals() and api_key_input.strip()) else resolve_api_key()
    if not key:
        return None
